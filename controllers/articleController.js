  ...
  try {
    ...
    for (let i = 0; i < numberOfArticles; i++) {
      ...
      const newArticle = {
        userId,
        value:
          "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corporis, nemo? Eveniet sed non minus, cupiditate mollitia placeat, velit repudiandae, fugit unde minima perferendis iure animi veniam magnam distinctio?",
      };
      await articleModel.create(newArticle);
      //   }
    }

    // Query articles by userId
